...
!!! info
    ...
    - [Slurm Storage Architecture](deploy_slurm.md#slurm-storage-architecture) -- How NFS and VAST mounts are used by Slurm.
...
- [Set Up Slurm](deploy_slurm.md) -- Deploy Slurm using the configured settings.
